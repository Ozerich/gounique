...
<div class="content">
    ...
    <div class="storeno-price-table">
        <table>
            <tr>
                <td class="paramname">Gesamptreisepreis</td>
                <td class="paramvalue"><?=$formular->original->price['brutto']?></td>
            </tr>
            <tr class="underline">
                <td class="paramname">Gutschrift</td>
                <td class="paramvalue">-<?=$formular->original->price['brutto']?></td>
            </tr>
            <tr class="up underline">
                <td class="paramname">Endpreise Netto</td>
                <td class="paramvalue">0.00</td>
            </tr>
